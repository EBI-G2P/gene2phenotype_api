...
class UserPanels(BaseView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        queryset_user_panels = (
            UserPanel.objects.filter(user=user_obj, is_deleted=0)
            .select_related("panel")
            .order_by("panel__description")
            .annotate(name=F("panel__name"), description=F("panel__description"))
