...
class PhenotypeTests(TestCase):
    ...
    def test_get_phenotype(self):
        ...
        """
        self.url_pheno = reverse("phenotype_details", kwargs={"hpo_list": "HP:0009726,HP:0010786"})
    ...
    def test_invalid(self):
        ...
        """
        self.url_pheno = reverse("phenotype_details", kwargs={"hpo_list": "HP:0009726,HP:0"})
        response = self.client.get(self.url_pheno)
